...
`VALIANT_MAIN_KEY_PATH` só é exigido para operações Valiant/Hyperliquid de transferência assinadas pelo usuário, como a transferência opcional spot→perps.
