...
The bot runs the full signal processing pipeline and simulates execution — no blockchain transactions are submitted. Use this for at least 24 hours before going live.
...
See [../trading/paper-mode.md](../trading/paper-mode.md) for full paper vs live behavior comparison.
...
Use systemd so the bot restarts automatically after reboots or crashes. See [../deployment/systemd.md](../deployment/systemd.md).
