...
Add backend-specific secrets only if your selected backend requires them. See [configuration.md](../operations/configuration.md).
...
See [configuration.md](../operations/configuration.md) for all available settings.
...
- [ ] Dashboard at `http://localhost:3000` responds (if `ENABLE_WEB=true`)
