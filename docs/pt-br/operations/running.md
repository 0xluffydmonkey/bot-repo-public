...
O bot executa o pipeline completo de processamento de sinais e simula a execução — nenhuma transação blockchain é enviada. Use por pelo menos 24 horas antes de operar com dinheiro real.
...
| Abertura manual | Abre uma posição manualmente (ignora o listener de sinais) |
